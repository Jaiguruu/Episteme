...
taken after M1 shipped — D35 and D36 are implemented in Stage 6.
...
Implemented in M2 (Stage 6): **D23–D31**, including **D27** (the pipeline
...
## Part 9 — M2 implementation (Stage 6)
